...
export default function KajabiZaPaystack({
  firstName = "there",
  unsubscribeUrl = "#",
}: Props) {
  return (
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            ...
            Paystack — let's get you selling in Rands.
          </Text>

          <Text style={paragraph}>
            Follow this setup guide to connect Paystack to your Kajabi checkout
            and start accepting local SA payments:
          </Text>

          <Section>
            <Button style={cta} href="https://checkoutjoy.com/docs/guides/kajabi/how-to-paystack-kajabi-setup-guide">
              Read: Paystack + Kajabi Guide →
            </Button>
          </Section>

          <Text style={paragraph}>
            Once connected, your students can pay with card, bank transfer, and
            other local methods — all in ZAR.
          </Text>
