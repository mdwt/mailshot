...
The entire infrastructure runs on pay-per-use AWS services:

- Under $5/month at 1,000 subscribers
- No SaaS fees ($0 vs $29–299/month for comparable tools)
- Claude Code usage is the only ongoing cost beyond AWS
