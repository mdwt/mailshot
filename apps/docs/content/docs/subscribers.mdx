---
title: Subscribers
description: Subscriber profiles, custom attributes, lifecycle states, tagging, automatic suppression after bounces, and HMAC-signed List-Unsubscribe handling.
---
