...
description: Claude Code skills bundled with mailshot for creating, validating, deploying, inspecting, and importing email sequences from natural-language prompts.
---
