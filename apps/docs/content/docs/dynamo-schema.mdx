...
description: Single-table DynamoDB design covering subscriber profiles, executions, send logs, tags, broadcasts, and engagement counters via inverted partner items.
---
