...
Choices can be nested (e.g., branch on platform, then on country within each platform). All branches converge automatically — steps after a choice run for all branches. See `examples/hello-world` for a reference implementation.
